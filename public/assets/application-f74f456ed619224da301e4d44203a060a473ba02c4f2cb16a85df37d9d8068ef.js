...
(function ($) {
    ...
    $.fn.render_form_errors = function (errors) {
        ...
        console.log("render_form_errors");
...
(function() {
  window.ExpensiveServices = (function() {
    var createNewExpensive, deleteExpense, doneCreateNewExpensiveModal, failCreateNewExpensiveModal, loadSubcategories;
    ...
    deleteExpense = function(expenseId, doneDeleteExpense, failDeleteExpense) {
      $.ajax({
        method: 'DELETE',
        url: '/expensives/' + expenseId
      }).done(doneDeleteExpense).fail(failDeleteExpense);
    };
    return {
...
(function() {
  window.ExpensiveIndexController = (function(expensiveServices) {
    var doneCreateNewExpensiveModal, doneDeleteExpense, doneLoadSubcategories, failCreateNewExpensiveModal, failDeleteExpense, failLoadSubcategories, init, initLoadForFilters, loadSubcategories, onClick_DeleteExpense, onDelete_Expense, renderFormErrors, resetFilters, showNewExpensive;
    init = function() {
    ...
    onClick_DeleteExpense = function(e) {
      var confirm, expenseId;
      e.preventDefault();
    ...
    onDelete_Expense = function(id) {
      console.log("Call services: " + id);
      return expensiveServices.deleteExpense(id, doneDeleteExpense, failDeleteExpense);
    };
    doneDeleteExpense = function(data) {
      console.log("done: " + data);
    };
    failDeleteExpense = function(err) {
      console.log("fail: " + err);
    };
    return {
      init: init
